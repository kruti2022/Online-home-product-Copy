                                    ...
                                    <div className="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div className="form-outline flex-fill mb-0">
                                            ...
                                            <div className="form-check form-check-inline">
                                                <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="office"
                                                    onChange={(e) => { setProductCategory(e.target.value); }} />
                                                <label className="form-check-label" htmlFor="inlineRadio1">Office</label>
                                            </div>
                                            <div className="form-check form-check-inline">
                                                <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="Living Room"
                                                    onChange={(e) => { setProductCategory(e.target.value); }} />
                                                <label className="form-check-label" htmlFor="inlineRadio2">Living Room</label>
                                            </div>
                                            <div className="form-check form-check-inline">
                                                <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="Dining"
                                                    onChange={(e) => { setProductCategory(e.target.value); }} />
                                                <label className="form-check-label" htmlFor="inlineRadio3">Dining</label>
                                            </div>
                                            <div className="form-check form-check-inline">
                                                <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio4" value="Bedroom"
                                                    onChange={(e) => { setProductCategory(e.target.value); }} />
